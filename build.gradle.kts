...
plugins {
    ...
    alias(libs.plugins.ktlint) // Kotlin linter and formatter
}
...
// Configure ktlint - exclude build scripts which often have long lines
ktlint {
    filter {
        exclude("*.gradle.kts")
    }
...
tasks {
    ...
    register("fmt") {
        description = "Format all Kotlin files"
        group = "formatting"
